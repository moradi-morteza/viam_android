package com.app.viam.persiancalendar.global
...
import com.app.viam.DEFAULT_AM
import com.app.viam.DEFAULT_ASCENDING_ATHAN_VOLUME
import com.app.viam.DEFAULT_ATHAN_VIBRATION
import com.app.viam.DEFAULT_AZERI_ALTERNATIVE_PERSIAN_MONTHS
import com.app.viam.DEFAULT_CITY
import com.app.viam.DEFAULT_DREAM_NOISE
import com.app.viam.DEFAULT_EASTERN_GREGORIAN_ARABIC_MONTHS
import com.app.viam.DEFAULT_ENGLISH_GREGORIAN_PERSIAN_MONTHS
import com.app.viam.DEFAULT_HIGH_LATITUDES_METHOD
import com.app.viam.DEFAULT_HOLIDAY
import com.app.viam.DEFAULT_IRAN_TIME
import com.app.viam.DEFAULT_ISLAMIC_OFFSET
import com.app.viam.DEFAULT_LOCAL_DIGITS
import com.app.viam.DEFAULT_NOTIFY_DATE
import com.app.viam.DEFAULT_NOTIFY_DATE_LOCK_SCREEN
import com.app.viam.DEFAULT_PM
import com.app.viam.DEFAULT_PRAY_TIME_METHOD
import com.app.viam.DEFAULT_RED_HOLIDAYS
import com.app.viam.DEFAULT_SECONDARY_CALENDAR_IN_TABLE
import com.app.viam.DEFAULT_THEME_GRADIENT
import com.app.viam.DEFAULT_VAZIR_ENABLED
import com.app.viam.DEFAULT_WALLPAPER_AUTOMATIC
import com.app.viam.DEFAULT_WALLPAPER_DARK
import com.app.viam.DEFAULT_WIDGET_CLOCK
import com.app.viam.DEFAULT_WIDGET_CUSTOMIZATIONS
import com.app.viam.DEFAULT_WIDGET_IN_24
import com.app.viam.DEFAULT_WIDGET_TRANSPARENCY
import com.app.viam.IRAN_TIMEZONE_ID
import com.app.viam.PREF_ALTITUDE
import com.app.viam.PREF_APP_LANGUAGE
import com.app.viam.PREF_ASCENDING_ATHAN_VOLUME
import com.app.viam.PREF_ASR_HANAFI_JURISTIC
import com.app.viam.PREF_ASTRONOMICAL_FEATURES
import com.app.viam.PREF_ATHAN_NAME
import com.app.viam.PREF_ATHAN_VIBRATION
import com.app.viam.PREF_AZERI_ALTERNATIVE_PERSIAN_MONTHS
import com.app.viam.PREF_CALENDARS_IDS_AS_HOLIDAY
import com.app.viam.PREF_CALENDARS_IDS_TO_EXCLUDE
import com.app.viam.PREF_CENTER_ALIGN_WIDGETS
import com.app.viam.PREF_DREAM_NOISE
import com.app.viam.PREF_EASTERN_GREGORIAN_ARABIC_MONTHS
import com.app.viam.PREF_ENGLISH_GREGORIAN_PERSIAN_MONTHS
import com.app.viam.PREF_GEOCODED_CITYNAME
import com.app.viam.PREF_HIGH_LATITUDES_METHOD
import com.app.viam.PREF_IRAN_TIME
import com.app.viam.PREF_ISLAMIC_OFFSET
import com.app.viam.PREF_LATITUDE
import com.app.viam.PREF_LOCAL_DIGITS
import com.app.viam.PREF_LONGITUDE
import com.app.viam.PREF_MAIN_CALENDAR_KEY
import com.app.viam.PREF_MIDNIGHT_METHOD
import com.app.viam.PREF_NOTIFICATION_ATHAN
import com.app.viam.PREF_NOTIFY_DATE
import com.app.viam.PREF_NOTIFY_DATE_LOCK_SCREEN
import com.app.viam.PREF_NUMERICAL_DATE_PREFERRED
import com.app.viam.PREF_OTHER_CALENDARS_KEY
import com.app.viam.PREF_PRAY_TIME_METHOD
import com.app.viam.PREF_RED_HOLIDAYS
import com.app.viam.PREF_SECONDARY_CALENDAR_IN_TABLE
import com.app.viam.PREF_SELECTED_LOCATION
import com.app.viam.PREF_SHIFT_WORK_RECURS
import com.app.viam.PREF_SHIFT_WORK_SETTING
import com.app.viam.PREF_SHIFT_WORK_STARTING_JDN
import com.app.viam.PREF_SHOW_DEVICE_CALENDAR_EVENTS
import com.app.viam.PREF_SHOW_WEEK_OF_YEAR_NUMBER
import com.app.viam.PREF_SWIPE_DOWN_ACTION
import com.app.viam.PREF_SWIPE_UP_ACTION
import com.app.viam.PREF_SYSTEM_DARK_THEME
import com.app.viam.PREF_SYSTEM_LIGHT_THEME
import com.app.viam.PREF_THEME
import com.app.viam.PREF_THEME_GRADIENT
import com.app.viam.PREF_VAZIR_ENABLED
import com.app.viam.PREF_WALLPAPER_AUTOMATIC
import com.app.viam.PREF_WALLPAPER_DARK
import com.app.viam.PREF_WEEK_ENDS
import com.app.viam.PREF_WEEK_START
import com.app.viam.PREF_WHAT_TO_SHOW_WIDGETS
import com.app.viam.PREF_WIDGETS_PREFER_SYSTEM_COLORS
import com.app.viam.PREF_WIDGET_CLOCK
import com.app.viam.PREF_WIDGET_IN_24
import com.app.viam.PREF_WIDGET_TRANSPARENCY
import com.app.viam.R
import com.app.viam.persiancalendar.entities.Calendar
import com.app.viam.persiancalendar.entities.EventsRepository
import com.app.viam.persiancalendar.entities.Jdn
import com.app.viam.persiancalendar.entities.Language
//import com.app.viam.persiancalendar.entities.PrayTime
//import com.app.viam.persiancalendar.entities.ShiftWorkRecord
//import com.app.viam.generated.citiesStore
import com.app.viam.persiancalendar.ui.SwipeDownAction
import com.app.viam.persiancalendar.ui.SwipeUpAction
//import com.app.viam.ui.theme.Theme
import com.app.viam.persiancalendar.utils.applyAppLanguage
import com.app.viam.persiancalendar.utils.getJdnOrNull
//import com.app.viam.persiancalendar.utils.isHighLatitude
import com.app.viam.persiancalendar.utils.isIslamicOffsetExpired
import com.app.viam.persiancalendar.utils.logException
import com.app.viam.persiancalendar.utils.preferences
//import com.app.viam.persiancalendar.utils.scheduleAlarms
import com.app.viam.persiancalendar.utils.splitFilterNotEmpty
import com.app.viam.persiancalendar.utils.debugAssertNotNull
import com.app.viam.persiancalendar.utils.debugLog
import com.app.viam.persiancalendar.calendar.AbstractDate
import com.app.viam.persiancalendar.calendar.CivilDate
import com.app.viam.persiancalendar.calendar.IslamicDate
import com.app.viam.persiancalendar.calendar.NepaliDate
import com.app.viam.persiancalendar.calendar.PersianDate
//import com.app.viam.persiancalendar.praytimes.AsrMethod
//import com.app.viam.persiancalendar.praytimes.CalculationMethod
//import com.app.viam.persiancalendar.praytimes.Coordinates
//import com.app.viam.persiancalendar.praytimes.HighLatitudesMethod
//import com.app.viam.persiancalendar.praytimes.MidnightMethod
