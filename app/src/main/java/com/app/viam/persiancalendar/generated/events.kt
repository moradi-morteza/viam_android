package com.app.viam.persiancalendar.generated
...
public val persianEvents: List<CalendarRecord> = listOf(
  ...
  CalendarRecord(
    title = "جشن دهقان",
    type = EventType.Afghanistan, isHoliday = true, month = 1, day = 2
  ),
  CalendarRecord(
    title = "روز زنگ مکتب",
    type = EventType.Afghanistan, isHoliday = false, month = 1, day = 3
  ),
  CalendarRecord(
    title = "روز مطبوعات",
    type = EventType.Afghanistan, isHoliday = false, month = 2, day = 5
  ),
  CalendarRecord(
    title = "کودتای حزب دموکراتیک خلق افغانستان (سال ۱۳۵۷)",
    type = EventType.Afghanistan, isHoliday = false, month = 2, day = 7
  ),
  CalendarRecord(
    title = "پیروزی جهاد مقدس افغانستان (سال ۱۳۷۱)",
    type = EventType.Afghanistan, isHoliday = true, month = 2, day = 8
  ),
  CalendarRecord(
    title = "روز مادر",
    type = EventType.Afghanistan, isHoliday = false, month = 3, day = 24
  ),
  CalendarRecord(
    title = "روز استرداد استقلال کشور (سال ۱۲۹۸ مصادف با ۱۹۱۹ میلادی)",
    type = EventType.Afghanistan, isHoliday = true, month = 5, day = 28
  ),
  CalendarRecord(
    title = "روز همبستگی با برادران پشتون و بلوچ",
    type = EventType.Afghanistan, isHoliday = false, month = 6, day = 9
  ),
  CalendarRecord(
    title = "روز شهادت قهرمان ملی افغانستان (آغاز هفتهٔ شهید)",
    type = EventType.Afghanistan, isHoliday = true, month = 6, day = 18
  ),
  CalendarRecord(
    title = "روز هنر",
    type = EventType.Afghanistan, isHoliday = false, month = 7, day = 16
  ),
  CalendarRecord(
    title = "روز جیودیزیست‌های کشور",
    type = EventType.Afghanistan, isHoliday = false, month = 7, day = 21
  ),
  CalendarRecord(
    title = "آغاز هفتهٔ مخصوص سره میاشت",
    type = EventType.Afghanistan, isHoliday = false, month = 7, day = 24
  ),
  CalendarRecord(
    title = "روز ملی زبان اوزبیکی",
    type = EventType.Afghanistan, isHoliday = false, month = 7, day = 29
  ),
  CalendarRecord(
    title = "روز وحدت ملی و شهادت شش عضو ولسی جرگه شورای ملی در بغلان (سال ۱۳۸۶)",
    type = EventType.Afghanistan, isHoliday = false, month = 8, day = 15
  ),
  CalendarRecord(
    title = "روز تحقیق و پژوهش",
    type = EventType.Afghanistan, isHoliday = false, month = 9, day = 13
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "روز متعاقدین",
    type = EventType.Afghanistan, isHoliday = false, month = 11, day = 10
  ),
  CalendarRecord(
    title = "روز شکست و خروج ارتش اتحاد شوروی سابق از افغانستان",
    type = EventType.Afghanistan, isHoliday = true, month = 11, day = 26
  ),
  CalendarRecord(
    title = "روز تکبیر و قیام مردم کابل در برابر تجاوز ارتش اتحاد شوروی سابق",
    type = EventType.Afghanistan, isHoliday = false, month = 12, day = 3
  ),
  CalendarRecord(
    title = "روز ملی حمایت از نیروهای دفاعی و امنیتی کشور",
    type = EventType.Afghanistan, isHoliday = false, month = 12, day = 9
  ),
  CalendarRecord(
    title = "روز حفاظت از میراث‌های فرهنگی کشور",
    type = EventType.Afghanistan, isHoliday = false, month = 12, day = 20
  ),
  CalendarRecord(
    title = "روز شهید وحدت ملی استاد عبدالعلی مزاری (۱۳۷۳)",
    type = EventType.Afghanistan, isHoliday = false, month = 12, day = 22
  ),
  CalendarRecord(
    title = "روز قیام مردم هرات بر علیه جمهوری دموکراتیک خلق افغانستان",
    type = EventType.Afghanistan, isHoliday = false, month = 12, day = 24
  ),
  CalendarRecord(
    title = "روز ملی خبرنگار",
    type = EventType.Afghanistan, isHoliday = false, month = 12, day = 27
  ),
  CalendarRecord(
    title = "آغاز نوروز",
    type = EventType.Iran, isHoliday = true, month = 1, day = 1
  ),
  CalendarRecord(
    title = "عید نوروز",
    type = EventType.Iran, isHoliday = true, month = 1, day = 2
  ),
  CalendarRecord(
    title = "هجوم مأموران ستم‌شاهی پهلوی به مدرسهٔ فیضیهٔ قم (۱۳۴۲ ه‍.ش)",
    type = EventType.Iran, isHoliday = false, month = 1, day = 2
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "عید نوروز",
    type = EventType.Iran, isHoliday = true, month = 1, day = 3
  ),
  CalendarRecord(
    title = "عید نوروز",
    type = EventType.Iran, isHoliday = true, month = 1, day = 4
  ),
  CalendarRecord(
    title = "زادروز زرتشت پیامبر",
    type = EventType.Iran, isHoliday = false, month = 1, day = 6
  ),
  CalendarRecord(
    title = "روز هنرهای نمایشی",
    type = EventType.Iran, isHoliday = false, month = 1, day = 7
  ),
  CalendarRecord(
    title = "روز جمهوری اسلامی ایران",
    type = EventType.Iran, isHoliday = true, month = 1, day = 12
  ),
  CalendarRecord(
    title = "روز طبیعت",
    type = EventType.Iran, isHoliday = true, month = 1, day = 13
  ),
  CalendarRecord(
    title = "روز ذخایر ژنتیکی و زیستی",
    type = EventType.Iran, isHoliday = false, month = 1, day = 15
  ),
  CalendarRecord(
    title = "روز سلامتی",
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 2, day = 2
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 2, day = 12
  ),
  CalendarRecord(
    title = "روز معلم",
    type = EventType.Iran, isHoliday = false, month = 2, day = 12
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 2, day = 18
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 2, day = 25
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 2, day = 28
  ),
  CalendarRecord(
    title = "روز ملی جمعیت",
    type = EventType.Iran, isHoliday = false, month = 2, day = 30
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 3, day = 5
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 3, day = 26
  ),
  CalendarRecord(
    title = "روز جهاد کشاورزی (تشکیل جهاد سازندگی به فرمان حضرت امام خمینی (ره)) (۱۳۵۸ ه‍.ش)",
    type = EventType.Iran, isHoliday = false, month = 3, day = 27
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 4, day = 8
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "روز قلم",
    type = EventType.Iran, isHoliday = false, month = 4, day = 14
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "روز مالیات",
    type = EventType.Iran, isHoliday = false, month = 4, day = 16
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 4, day = 21
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 4, day = 22
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 4, day = 23
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 4, day = 25
  ),
  CalendarRecord(
    title = "سالروز تأسیس نهاد شورای نگهبان (۱۳۵۹ ه‍.ش)",
    type = EventType.Iran, isHoliday = false, month = 4, day = 26
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 5, day = 4
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 5, day = 14
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 5, day = 15
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 5, day = 18
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 5, day = 23
  ),
  CalendarRecord(
    title = "آغاز بازگشت آزادگان به میهن اسلامی (۱۳۶۹ ه‍.ش)",
    type = EventType.Iran, isHoliday = false, month = 5, day = 26
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 6, day = 1
  ),
  CalendarRecord(
    title = "روز پزشک",
    type = EventType.Iran, isHoliday = false, month = 6, day = 1
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 7, day = 8
  ),
  CalendarRecord(
    title = "روز نخبگان",
    type = EventType.Iran, isHoliday = false, month = 7, day = 10
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "روز دامپزشکی",
    type = EventType.Iran, isHoliday = false, month = 7, day = 14
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 8, day = 13
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "روز بیمه",
    type = EventType.Iran, isHoliday = false, month = 9, day = 13
  ),
  CalendarRecord(
    title = "روز دانشجو",
  ...
  CalendarRecord(
    title = "روز پژوهش",
    type = EventType.Iran, isHoliday = false, month = 9, day = 25
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 9, day = 29
  ),
  CalendarRecord(
    title = "شب یلدا (چله)",
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 10, day = 4
  ),
  CalendarRecord(
    title = "روز ایمنی در برابر زلزله و کاهش اثرات بلایای طبیعی",
    type = EventType.Iran, isHoliday = false, month = 10, day = 5
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 11, day = 29
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 12, day = 8
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 12, day = 9
  ),
  CalendarRecord(
    title = "روز احسان و نیکوکاری",
    type = EventType.Iran, isHoliday = false, month = 12, day = 14
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 12, day = 20
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.AncientIran, isHoliday = false, month = 1, day = 6
  ),
  CalendarRecord(
    title = "آیین نیایش پیر هریشت از ۷ تا ۱۱ فروردین",
    type = EventType.AncientIran, isHoliday = false, month = 1, day = 7
  ),
  CalendarRecord(
    title = "سیزده نوروز، سیزده‌بدر",
    type = EventType.AncientIran, isHoliday = false, month = 1, day = 13
  ),
  CalendarRecord(
    title = "جشن فرودینگان",
    type = EventType.AncientIran, isHoliday = false, month = 1, day = 19
  ),
  CalendarRecord(
    title = "جشن اردیبهشتگان، پوشیدن لباس سپید به نشانه پاکی",
    type = EventType.AncientIran, isHoliday = false, month = 2, day = 2
  ),
  CalendarRecord(
    title = "جشن چلمو (چله بهار) - گاهان بار میدیوزرم‌گاه از ۱۰ تا ۱۴ اردیبهشت",
    type = EventType.AncientIran, isHoliday = false, month = 2, day = 10
  ),
  CalendarRecord(
    title = "جشن پنجاه بدر",
    type = EventType.AncientIran, isHoliday = false, month = 2, day = 19
  ),
  CalendarRecord(
    title = "بزرگداشت استاد توس فردوسی بزرگ",
    type = EventType.AncientIran, isHoliday = false, month = 2, day = 25
  ),
  CalendarRecord(
    title = "جشن خوردادگان، امشاسپند خورداد نگاهبان آبها",
    type = EventType.AncientIran, isHoliday = false, month = 3, day = 4
  ),
  CalendarRecord(
    title = "آیین نیایش ستی پیر و پیر سبز (چک چک)",
    type = EventType.AncientIran, isHoliday = false, month = 3, day = 24
  ),
  CalendarRecord(
    title = "جشن ابتدای تیر ماه، آب پاشونک",
    type = EventType.AncientIran, isHoliday = false, month = 3, day = 29
  ),
  CalendarRecord(
    title = "آیین نیایش پیر نارستانه",
    type = EventType.AncientIran, isHoliday = false, month = 4, day = 2
  ),
  CalendarRecord(
    title = "گاهان بار میدیوشهیم‌گاه از ۸ تا ۱۲ تیر",
    type = EventType.AncientIran, isHoliday = false, month = 4, day = 8
  ),
  CalendarRecord(
    title = "جشن تیرگان، آب پاشونک",
    type = EventType.AncientIran, isHoliday = false, month = 4, day = 10
  ),
  CalendarRecord(
    title = "آیین نیایش پارس بانو از ۱۳ تا ۱۷ تیر",
    type = EventType.AncientIran, isHoliday = false, month = 4, day = 13
  ),
  CalendarRecord(
    title = "جشن امردادگان، امشاسپند امرداد نگاهبان رستنی‌ها",
    type = EventType.AncientIran, isHoliday = false, month = 5, day = 3
  ),
  CalendarRecord(
    title = "جشن چلهٔ تابستان",
    type = EventType.AncientIran, isHoliday = false, month = 5, day = 6
  ),
  CalendarRecord(
    title = "آیین نیایش پیر نارکی از ۱۲ تا ۱۶ مرداد",
    type = EventType.AncientIran, isHoliday = false, month = 5, day = 12
  ),
  CalendarRecord(
    title = "جشن شهریورگان، امشاسپند شهریور نگاهبان فلزات",
    type = EventType.AncientIran, isHoliday = false, month = 5, day = 30
  ),
  CalendarRecord(
    title = "جشن خزان",
    type = EventType.AncientIran, isHoliday = false, month = 6, day = 3
  ),
  CalendarRecord(
    title = "گاهان‌بار پتیه‌شهیم‌گاه از ۲۱ تا ۲۵ شهریور",
    type = EventType.AncientIran, isHoliday = false, month = 6, day = 21
  ),
  CalendarRecord(
    title = "جشن مهرگان",
    type = EventType.AncientIran, isHoliday = false, month = 7, day = 10
  ),
  CalendarRecord(
    title = "جشن آبانگان",
    type = EventType.AncientIran, isHoliday = false, month = 8, day = 4
  ),
  CalendarRecord(
    title = "روز کوروش بزرگ",
    type = EventType.AncientIran, isHoliday = false, month = 8, day = 7
  ),
  CalendarRecord(
    title = "جشن پاییزانه",
    type = EventType.AncientIran, isHoliday = false, month = 8, day = 9
  ),
  CalendarRecord(
    title = "جشن گالشی",
    type = EventType.AncientIran, isHoliday = false, month = 8, day = 21
  ),
  CalendarRecord(
    title = "جشن آذرگان",
    type = EventType.AncientIran, isHoliday = false, month = 9, day = 3
  ),
  CalendarRecord(
    title = "اولین جشن دی‌گان",
    type = EventType.AncientIran, isHoliday = false, month = 9, day = 25
  ),
  CalendarRecord(
    title = "جشن شب یلدا",
    type = EventType.AncientIran, isHoliday = false, month = 9, day = 30
  ),
  CalendarRecord(
    title = "دومین جشن دی‌گان",
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 2
  ),
  CalendarRecord(
    title = "جشن سیر و سور",
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 8
  ),
  CalendarRecord(
    title = "سومین جشن دی‌گان",
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 9
  ),
  CalendarRecord(
    title = "چهارمین جشن دی‌گان",
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 17
  ),
  CalendarRecord(
    title = "جشن بهمنگان، روز پدر، بهمن (منش نیک) امشاسپند",
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 26
  ),
  CalendarRecord(
    title = "جشن نوسده",
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 29
  ),
  CalendarRecord(
    title = "جشن میانهٔ زمستان",
    type = EventType.AncientIran, isHoliday = false, month = 11, day = 9
  ),
  CalendarRecord(
    title = "جشن سده، آتش افروزی به هنگام غروب آفتاب",
    type = EventType.AncientIran, isHoliday = false, month = 11, day = 10
  ),
  CalendarRecord(
    title = "جشن اسفندگان، روز مادر و روز عشق پاک",
    type = EventType.AncientIran, isHoliday = false, month = 11, day = 29
  ),
  CalendarRecord(
    title = "جشن گلدان (اینجه، رسیدگی به امور نباتات)",
    type = EventType.AncientIran, isHoliday = false, month = 12, day = 14
  ),
)
...
public val islamicEvents: List<CalendarRecord> = listOf(
  CalendarRecord(
    title = "روز عاشورا",
    type = EventType.Afghanistan, isHoliday = true, month = 1, day = 10
  ),
  CalendarRecord(
    title = "روز میلاد نبی (ص)",
    type = EventType.Afghanistan, isHoliday = true, month = 3, day = 12
  ),
  CalendarRecord(
    title = "اول ماه مبارک رمضان",
    type = EventType.Afghanistan, isHoliday = true, month = 9, day = 1
  ),
  CalendarRecord(
    title = "روز حمایت از اطفال آسیب‌پذیر، یتیم و بی‌سرپرست",
    type = EventType.Afghanistan, isHoliday = false, month = 9, day = 15
  ),
  CalendarRecord(
    title = "روز گرامیداشت از نزول قرآن عظیم‌الشان",
    type = EventType.Afghanistan, isHoliday = false, month = 9, day = 27
  ),
  CalendarRecord(
    title = "عید سعید فطر",
    type = EventType.Afghanistan, isHoliday = true, month = 10, day = 1
  ),
  CalendarRecord(
    title = "عید سعید فطر، روز دوم",
    type = EventType.Afghanistan, isHoliday = true, month = 10, day = 2
  ),
  CalendarRecord(
    title = "عید سعید فطر، روز سوم",
    type = EventType.Afghanistan, isHoliday = true, month = 10, day = 3
  ),
  CalendarRecord(
    title = "روز عرفه و عید سعید اضحی",
    type = EventType.Afghanistan, isHoliday = true, month = 12, day = 9
  ),
  CalendarRecord(
    title = "روز عرفه و عید سعید اضحی",
    type = EventType.Afghanistan, isHoliday = true, month = 12, day = 10
  ),
  CalendarRecord(
    title = "روز عرفه و عید سعید اضحی",
    type = EventType.Afghanistan, isHoliday = true, month = 12, day = 11
  ),
  CalendarRecord(
    title = "روز عرفه و عید سعید اضحی",
    type = EventType.Afghanistan, isHoliday = true, month = 12, day = 12
  ),
  CalendarRecord(
    title = "آغاز سال هجری قمری",
    type = EventType.Iran, isHoliday = false, month = 1, day = 1
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "تاسوعای حسینی",
    type = EventType.Iran, isHoliday = true, month = 1, day = 9
  ),
  CalendarRecord(
    title = "عاشورای حسینی",
    type = EventType.Iran, isHoliday = true, month = 1, day = 10
  ),
  CalendarRecord(
    title = "روز تجلیل از اسرا و مفقودان",
    type = EventType.Iran, isHoliday = false, month = 1, day = 11
  ),
  CalendarRecord(
    title = "شهادت حضرت امام زین‌العابدین (ع) (۹۵ ه‍.ق)",
    type = EventType.Iran, isHoliday = false, month = 1, day = 12
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "اربعین حسینی",
    type = EventType.Iran, isHoliday = true, month = 2, day = 20
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "روز وقف",
    type = EventType.Iran, isHoliday = false, month = 3, day = 16
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 5, day = 13
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 7, day = 1
  ),
  CalendarRecord(
    title = "شهادت حضرت امام علی النقی الهادی (ع) (۲۵۴ ه‍.ق)",
    type = EventType.Iran, isHoliday = false, month = 7, day = 3
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = true, month = 7, day = 13
  ),
  CalendarRecord(
    title = "روز پدر",
    type = EventType.Iran, isHoliday = false, month = 7, day = 13
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = true, month = 7, day = 27
  ),
  CalendarRecord(
    title = "ولادت حضرت امام حسین (ع) (۴ ه‍.ق) و روز پاسدار",
    type = EventType.Iran, isHoliday = false, month = 8, day = 3
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = true, month = 8, day = 15
  ),
  CalendarRecord(
    title = "روز سربازان گمنام حضرت امام زمان (عج)",
    type = EventType.Iran, isHoliday = false, month = 8, day = 15
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = true, month = 9, day = 21
  ),
  CalendarRecord(
    title = "شب قدر",
    type = EventType.Iran, isHoliday = false, month = 9, day = 22
  ...
  CalendarRecord(
    title = "عید سعید فطر",
    type = EventType.Iran, isHoliday = true, month = 10, day = 1
  ),
  CalendarRecord(
    title = "تعطیل به مناسبت عید سعید فطر",
    type = EventType.Iran, isHoliday = true, month = 10, day = 2
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 10, day = 21
  ),
  CalendarRecord(
    title = "شهادت حضرت امام جعفر صادق (ع) (۱۴۸ ه‍.ق)",
    type = EventType.Iran, isHoliday = true, month = 10, day = 25
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 12, day = 7
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = true, month = 12, day = 10
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 12, day = 24
  ),
  CalendarRecord(
...
public val gregorianEvents: List<CalendarRecord> = listOf(
  CalendarRecord(
    ...
    type = EventType.Afghanistan, isHoliday = false, month = 1, day = 21
  ),
  CalendarRecord(
    title = "روز جهانی زن",
    type = EventType.Afghanistan, isHoliday = false, month = 3, day = 8
  ),
  CalendarRecord(
    title = "روز جهانی حقوق مستهلک",
    type = EventType.Afghanistan, isHoliday = false, month = 3, day = 15
  ),
  CalendarRecord(
    title = "روز جهانی آب",
    type = EventType.Afghanistan, isHoliday = false, month = 3, day = 22
  ),
  CalendarRecord(
    title = "روز جهانی هواشناسی",
    type = EventType.Afghanistan, isHoliday = false, month = 3, day = 23
  ),
  CalendarRecord(
    title = "روز بین‌المللی کارگر",
    type = EventType.Afghanistan, isHoliday = false, month = 5, day = 1
  ),
  CalendarRecord(
    title = "روز قلم",
    type = EventType.Afghanistan, isHoliday = false, month = 5, day = 6
  ),
  CalendarRecord(
    title = "روز جهانی تیلی‌کمیونیکیشن",
    type = EventType.Afghanistan, isHoliday = false, month = 5, day = 17
  ),
  CalendarRecord(
    title = "روز بین‌المللی موزیم‌ها",
    type = EventType.Afghanistan, isHoliday = false, month = 5, day = 18
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Afghanistan, isHoliday = false, month = 6, day = 20
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Afghanistan, isHoliday = false, month = 8, day = 21
  ),
  CalendarRecord(
    title = "روز بین‌المللی سواد",
    type = EventType.Afghanistan, isHoliday = false, month = 9, day = 8
  ),
  CalendarRecord(
    title = "روز جهانی صلح",
    type = EventType.Afghanistan, isHoliday = false, month = 9, day = 21
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Afghanistan, isHoliday = false, month = 10, day = 5
  ),
  CalendarRecord(
    title = "روز جهانی پست",
    type = EventType.Afghanistan, isHoliday = false, month = 10, day = 9
  ),
  CalendarRecord(
    title = "روز جهانی کاهش خطرپذیری",
    type = EventType.Afghanistan, isHoliday = false, month = 10, day = 12
  ),
  CalendarRecord(
    title = "روز جهانی غذا",
    type = EventType.Afghanistan, isHoliday = false, month = 10, day = 16
  ),
  CalendarRecord(
    title = "روز جهانی ملل متحد",
    type = EventType.Afghanistan, isHoliday = false, month = 10, day = 24
  ),
  CalendarRecord(
    title = "روز جهانی محصلان",
    type = EventType.Afghanistan, isHoliday = false, month = 11, day = 17
  ),
  CalendarRecord(
    title = "روز جهانی هوانوردی",
    type = EventType.Afghanistan, isHoliday = false, month = 12, day = 7
  ),
  CalendarRecord(
    title = "روز جهانی مهاجرت",
    type = EventType.Afghanistan, isHoliday = false, month = 12, day = 18
  ),
  CalendarRecord(
    title = "روز جهانی سینما",
    type = EventType.Afghanistan, isHoliday = false, month = 12, day = 28
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 1, day = 26
  ),
  CalendarRecord(
    title = "روز جهانی آب",
    type = EventType.Iran, isHoliday = false, month = 3, day = 22
  ),
  CalendarRecord(
    title = "روز جهانی هواشناسی",
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 6, day = 26
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 8, day = 6
  ),
  CalendarRecord(
    title = "روز جهانی مسجد",
    type = EventType.Iran, isHoliday = false, month = 8, day = 21
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 10, day = 14
  ),
  CalendarRecord(
    title = "روز جهانی نابینایان (عصای سفید)",
    type = EventType.Iran, isHoliday = false, month = 10, day = 15
  ),
  CalendarRecord(
    title = "روز جهانی غذا",
    type = EventType.Iran, isHoliday = false, month = 10, day = 16
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 11, day = 10
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 1, day = 4
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 2, day = 6
  ),
  CalendarRecord(
    title = "روز جهانی حبوبات",
    type = EventType.International, isHoliday = false, month = 2, day = 10
  ),
  CalendarRecord(
    title = "روز جهانی زن و دختر در علم",
    type = EventType.International, isHoliday = false, month = 2, day = 11
  ),
  CalendarRecord(
    title = "روز جهانی رادیو",
    type = EventType.International, isHoliday = false, month = 2, day = 13
  ),
  CalendarRecord(
    title = "روز جهانی عدالت اجتماعی",
    type = EventType.International, isHoliday = false, month = 2, day = 20
  ),
  CalendarRecord(
    title = "روز جهانی زبان مادری",
    type = EventType.International, isHoliday = false, month = 2, day = 21
  ),
  CalendarRecord(
    title = "روز جهانی بدون تبعیض",
    type = EventType.International, isHoliday = false, month = 3, day = 1
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 3, day = 20
  ),
  CalendarRecord(
    title = "روز جهانی شعر",
    type = EventType.International, isHoliday = false, month = 3, day = 21
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "روز جهانی سل",
    type = EventType.International, isHoliday = false, month = 3, day = 24
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 4, day = 22
  ),
  CalendarRecord(
    title = "روز جهانی کتاب و حق مؤلف",
    type = EventType.International, isHoliday = false, month = 4, day = 23
  ),
  CalendarRecord(
    title = "روز جهانی مالاریا",
    type = EventType.International, isHoliday = false, month = 4, day = 25
  ),
  CalendarRecord(
    title = "روز جهانی گرافیک",
    type = EventType.International, isHoliday = false, month = 4, day = 27
  ),
  CalendarRecord(
    title = "روز جهانی ایمنی و بهداشت حرفه‌ای",
    type = EventType.International, isHoliday = false, month = 4, day = 28
  ),
  CalendarRecord(
    title = "روز جهانی آزادی مطبوعات",
    type = EventType.International, isHoliday = false, month = 5, day = 3
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 5, day = 20
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 6, day = 10
  ),
  CalendarRecord(
    title = "روز جهانی منع کار کودکان",
    type = EventType.International, isHoliday = false, month = 6, day = 12
  ),
  CalendarRecord(
    title = "روز جهانی اهدای خون",
    type = EventType.International, isHoliday = false, month = 6, day = 14
  ),
  CalendarRecord(
    title = "روز جهانی پناهندگان",
    type = EventType.International, isHoliday = false, month = 6, day = 20
  ),
  CalendarRecord(
    title = "روز جهانی موسیقی",
    type = EventType.International, isHoliday = false, month = 6, day = 21
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 9, day = 21
  ),
  CalendarRecord(
    title = "روز جهانی صلح",
    type = EventType.International, isHoliday = false, month = 9, day = 21
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 9, day = 30
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 10, day = 24
  ),
  CalendarRecord(
    title = "روز جهانی هنرمند",
    type = EventType.International, isHoliday = false, month = 10, day = 25
  ),
  CalendarRecord(
    title = "روز جهانی میراث سمعی و بصری",
    type = EventType.International, isHoliday = false, month = 10, day = 27
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 10, day = 31
  ),
  CalendarRecord(
    title = "جشن هالووین",
    type = EventType.International, isHoliday = false, month = 10, day = 31
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 11, day = 6
  ),
  CalendarRecord(
    title = "روز جهانی حسابداری",
    type = EventType.International, isHoliday = false, month = 11, day = 10
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 11, day = 25
  ),
  CalendarRecord(
    title = "روز جهانی همبستگی با مردم فلسطین",
    type = EventType.International, isHoliday = false, month = 11, day = 29
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.International, isHoliday = false, month = 12, day = 10
  ),
  CalendarRecord(
    title = "روز جهانی کوهستان",
    type = EventType.International, isHoliday = false, month = 12, day = 11
  ),
)
